...
abstract class WebSocketServer {
	...
	protected $userClass = 'app\common\WebSocketUser'; // redefine this if you want a custom user class.  The custom user class should inherit from WebSocketUser.
...
/**
 * Simple class to accept WebSocket client
 *
 * Class WebSocketUser
 * @package app\common
 */
